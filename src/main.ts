...
const WHISPERPLUS = new WhisperPlus(ICON_HEIGHT, ICON_WIDTH, CRABS, bcModSDK.getModsInfo());
const ROSTER = new Roster(ICON_HEIGHT, ICON_WIDTH, , CRABS, bcModSDK.getModsInfo());
